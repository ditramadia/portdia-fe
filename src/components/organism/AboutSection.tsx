...
const AboutSection = () => {
  return (
    <div className='w-11/12 pb-20 flex flex-col gap-7 items-center'>
      ...
      <div className='w-full flex flex-col items-center gap-7'>
        ...
        <a target="_blank" href="https://drive.google.com/file/d/1CRswzCp9LZNwNbTxMcPSmIMR6LAXf0Ng/view?usp=sharing" rel="noopener noreferrer">
          <div className='relative w-[150px] group'>
            ...
            <div className='absolute -z-10 -top-[140px] -right-[120px] w-[300px] h-[300px] rounded-full bg-gradient-radial from-blue_main to-transparent to-65% opacity-20 transition-opacity duration-300 ease-in-out group-hover:opacity-30'></div>
          </div>
        </a>
      </div>
