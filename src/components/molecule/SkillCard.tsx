...
const SkillCard = (props: SkillCardProps) => {
  ...
  return (
    <div className='w-[340px] h-[180px] p-6 flex flex-col justify-center items-center gap-4 bg-white/20 border-[1px] border-solid border-white rounded-lg text-center'>
